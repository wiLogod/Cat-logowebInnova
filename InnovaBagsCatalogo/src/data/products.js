...
export const products = [
  ...
  { id: 103, name: "Acalia", category: "Carteras", image: Acaliacartera14, destacado: false,
    colors: [{ name: "Negro", stock: 28 }, { name: "Plateado", stock: 30 }, { name: "Rosa", stock: 25 }] },
  ...
  { id: 201, name: "Adina", category: "Morrales", image: Adinamorral4, destacado: false,
    colors: [{ name: "Negro", stock: 12 }, { name: "Rosa", stock: 16 }] },
  ...
  { id: 301, name: "Aina", category: "Mochilas", image: Ainamochila2, destacado: false,
    colors: [{ name: "Negro", stock: 10 }, { name: "Rosa", stock: 18 }, { name: "Marrón", stock: 8 }] },
  { id: 302, name: "Ainara", category: "Mochilas", image: Ainaramochila3, destacado: false,
    colors: [{ name: "Azul", stock: 30 }, { name: "Beige", stock: 29 }, { name: "Verde", stock: 30 }, { name: "Negro", stock: 55 }] },
  { id: 303, name: "Barbara", category: "Mochilas", image: Barbaramochila4, destacado: false,
    colors: [{ name: "Negro", stock: 25 }, { name: "Azul Marino", stock: 25 }, { name: "Rojo", stock: 36 }, { name: "Beige", stock: 7 }] },
  ...
  { id: 601, name: "Alexia", category: "Etiquetas", image: Alexiaetiqueta8, destacado: false,
    colors: [{ name: "Rosa", stock: 18 }, { name: "Marrón", stock: 21 }, { name: "Beige", stock: 9 }, { name: "Gris", stock: 19 }, { name: "Azul", stock: 13 }] }
];